                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Badge className={getStatusColor(selectedReview.status)}>
                      ...
                      <span className="ml-1">{selectedReview.status.replace('_', ' ')}</span>
                    </Badge>
                  </div>
                </div>
              </CardHeader>
                ...
                <Tabs defaultValue="reply" className="w-full">
                  ...
                  <TabsContent value="ticket" className="space-y-4">
                    <div className="text-center py-8">
                      ...
                      <h3 className="text-lg font-medium mb-2">Create Support Ticket</h3>
                      <p className="text-gray-600 mb-4">
                        This review requires special attention and should be escalated to a support ticket.
                      </p>
