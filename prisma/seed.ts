...
async function main() {
  ...
  const business1 = await prisma.business.upsert({
    ...
    create: {
      ...
      brandRules:
        "We are a family-owned Italian restaurant focused on authentic cuisine and warm hospitality. Always be friendly, professional, and apologize when appropriate. Never make promises we cannot keep.",
      tone: "friendly",
      ownerId: owner.id,
    },
  });
  ...
  const business2 = await prisma.business.upsert({
    ...
    create: {
      ...
      brandRules:
        "We are a professional technology consulting firm. Maintain a professional, knowledgeable tone. Focus on solutions and technical expertise.",
      tone: "professional",
      ownerId: owner.id,
    },
  });
  ...
  const replies = [
    {
      ...
      reviewId: "review-4",
      draftText:
        "Thank you so much for your wonderful review, Emily! We're thrilled to hear you enjoyed the food and wine selection. We appreciate your feedback about the noise level and will look into ways to improve the acoustics. We look forward to welcoming you back soon!",
      finalText:
        "Thank you so much for your wonderful review, Emily! We're thrilled to hear you enjoyed the food and wine selection. We appreciate your feedback about the noise level and will look into ways to improve the acoustics. We look forward to welcoming you back soon!",
      tone: "friendly",
